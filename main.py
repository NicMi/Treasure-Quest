...
if lake == "wait":
 Colored_Door = input("You arrive at the island unharmed. There is a house with 3 doors. One red, one yellow and one blue. Which colour do you choose?\n").lower()
else:
  print("You get attacked by an angry trout. Game Over.")
if Colored_Door == "yellow":
 print("You found the treasure, you win!")
elif Colored_Door == "blue":
 print("You have been eaten by beasts. Game Over")
elif Colored_Door == "red":
